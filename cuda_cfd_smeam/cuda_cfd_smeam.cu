...
CUDA_CFD_sMEAM::CUDA_CFD_sMEAM(int max_number_of_central_forces)
{
...
void CUDA_CFD_sMEAM::allocateMemory()
{
#ifdef CFD_SMEAM_TIMINGS
...
void CUDA_CFD_sMEAM::deallocateMemory()
{
#ifdef CFD_SMEAM_TIMINGS
...
void CUDA_CFD_sMEAM::readPotentialFile(std::string file_name)
{
#ifdef CFD_SMEAM_TIMINGS
...
#endif
			phi_spline_ = new CudaSpline();
			phi_spline_->readFromASCIIFile(input);
#ifdef CFD_SMEAM_DEBUG
			phi_spline_->ShowParams();
...
#endif
			rho_spline_ = new CudaSpline();
			rho_spline_->readFromASCIIFile(input);
#ifdef CFD_SMEAM_DEBUG
			rho_spline_->ShowParams();
			std::cout << "done!" << std::endl;
			std::cout << std::endl;
#endif
		}
...
#endif
			U_spline_ = new CudaSpline();
			U_spline_->readFromASCIIFile(input);
#ifdef CFD_SMEAM_DEBUG
			U_spline_->ShowParams();
			std::cout << "done!" << std::endl;
			std::cout << std::endl;
#endif
		}
...
#endif
			f_spline_ = new CudaSpline();
			f_spline_->readFromASCIIFile(input);
#ifdef CFD_SMEAM_DEBUG
			f_spline_->ShowParams();
			std::cout << "done!" << std::endl;
			std::cout << std::endl;
#endif
		}
...
#endif
			g_spline_ = new CudaSpline();
			g_spline_->readFromASCIIFile(input);
#ifdef CFD_SMEAM_DEBUG
			g_spline_->ShowParams();
			std::cout << "done!" << std::endl;
			std::cout << std::endl;
#endif
		}
...
void CUDA_CFD_sMEAM::readNeighboursList(std::string file_name)
{
#ifdef CFD_SMEAM_TIMINGS
